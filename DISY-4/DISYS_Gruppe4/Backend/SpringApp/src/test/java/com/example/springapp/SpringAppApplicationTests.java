...
class SpringAppApplicationTests {
	...
	void gatherDataTestFail() {
		...
		assertEquals(
				new ResponseEntity<>("The request to gather the data could not be sent!", HttpStatus.INTERNAL_SERVER_ERROR),
				data
		);
	...
	void gatherDataTestSuccess() {
		...
		assertEquals(
				new ResponseEntity<>("The request to gather the data has been sent!", HttpStatus.OK),
				data
		);
